...
The current local gate passes **369 tests in 74.54 seconds**, compilation, Ruff,
formatting and canonical notebook-source parity. All five public research notebooks
execute and replay with the in-process engine. Historical CPU reference checks
pass on synthetic and original preview data, including unchanged-output replay.
The prior research publication commit `78ca8f4b9ce5603d8b99a62da67eb5633fce8c85`
passed 360 tests and all five actual Jupyter executions/replays in
[CI run 34415239828](https://github.com/alvaromendizabal/jigsaw-rule-classifier/actions/runs/34415239828).
New runtime CI is tracked separately from that research result.
...
full manifest and actual executed output are preserved in
[the runtime receipt](../reports/checkpoints/kaggle_adaptation.json) and
[the canonical notebook](../kaggle/submission.ipynb). The old lexical notebook is
