...
cd /opt/ml/code
exec /opt/ml/feature-env/bin/python -m scripts.complementary_worker \
  --plan /opt/ml/code/adaptation_plan.json --output /opt/ml/complementary-work \
  --bucket "$JIGSAW_BUCKET" --prefix "$JIGSAW_COMPLEMENTARY_PREFIX"
