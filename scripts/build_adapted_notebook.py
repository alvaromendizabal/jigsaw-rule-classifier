...
def build(root: Path, destination: Path | None = None):
    cells = [
        nbformat.v4.new_markdown_cell(
            ...
            "Verified late Kaggle Version 3 (348640051), implementation a493697, scored "
            "0.91808 public / 0.91425 private AUC, checked September 10, 2026 at 02:20 UTC. "
            "The 0.92–0.93 target remains open. This publication adds result documentation; "
            "the scored saved version is unchanged.\n\n"
...
""")
    ...
    cells.append(
        nbformat.v4.new_markdown_cell(
            ...
            "Download the validated CSV below, or use Kaggle's Output panel. The ten-row "
            "preview checks execution only. Kaggle replaces it with hidden inputs when "
            "the saved notebook version is submitted. A new score is recorded only after "
            "Kaggle finishes that hidden run. This notebook does not submit automatically."
        )
    )
    cells.append(
        nbformat.v4.new_code_cell(
...
if __name__ == "__main__":
    ...
    build(project, project / "kaggle/submission.ipynb")
